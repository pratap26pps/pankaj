...
const About = () => {
  return (
    <>
      ...
      <div className="min-h-screen bg-green-50 pt-24" style={{ fontFamily: 'poppins, sans-serif' }}>
        {/* Background Elements */}
                ...
                >
                  ...
                  <div className="relative p-8 sm:p-10 lg:p-16">
                    <div className="text-center mb-12">
                      ...
                      >
                        <h1
                          className="text-2xl sm:text-3xl md:text-4xl font-semibold text-gray-900 mb-4 leading-tight"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                      ...
                      <motion.div initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 0.2 }} whileHover={{ scale: 1.03, y: -8, transition: { duration: 0.3 } }} className="h-full">
                        <div className="h-full text-center border-0 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 group/card" style={{ background: 'linear-gradient(135deg, #d1fae5 0%, #a7f3d0 50%, #6ee7b7 100%)', border: '2px solid rgba(59, 130, 246, 0.2)' }}>
                          <div className="relative p-8">
                            ...
                            <h3 className="text-xl sm:text-2xl font-bold text-emerald-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif', letterSpacing: '-0.01em' }}>Our Mission</h3>
                            <p className="text-sm text-gray-900 font-normal leading-snug mb-2" style={{ fontFamily: 'poppins, sans-serif', lineHeight: '1.5' }}>
                            ...
                            <div className="flex flex-wrap justify-center gap-2 mt-4">
                              <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-semibold">Silent</span>
                              <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-semibold">Sustainable</span>
                      ...
                      <motion.div initial={{ x: -50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 0.6 }} whileHover={{ scale: 1.03, y: -8, transition: { duration: 0.3 } }} className="h-full">
                        <div className="h-full text-center border-0 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 group/card" style={{ background: 'linear-gradient(135deg, #d1fae5 0%, #a7f3d0 50%, #6ee7b7 100%)', border: '2px solid rgba(59, 130, 246, 0.2)' }}>
                          <div className="relative p-8">
                            ...
                            <h3 className="text-xl sm:text-2xl font-bold text-emerald-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif', letterSpacing: '-0.01em' }}>Smart Battery Systems</h3>
                            ...
                            <div className="flex flex-wrap justify-center gap-2 mt-4">
                              <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-semibold">Silent</span>
                              <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-semibold">Efficient</span>
                              <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-semibold">Smart</span>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="relative p-8">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3 px-4 py-3 bg-white/20 backdrop-blur-sm rounded-full border border-white/30 justify-center">
                          ...
                          <div>
                            <span className="text-blue-900 font-semibold text-sm block" style={{ fontFamily: 'poppins, sans-serif' }}>Office</span>
                            <span className="text-blue-800 text-xs truncate" style={{ fontFamily: 'poppins, sans-serif' }}>Safdarjung Enclave</span>
                          </div>
                        </div>
                        <a href="tel:+917982737801" className="flex items-center gap-3 px-4 py-3 bg-white/20 backdrop-blur-sm rounded-full border border-white/30 justify-center">
                          ...
                          <div>
                            <span className="text-blue-900 font-semibold text-sm block" style={{ fontFamily: 'poppins, sans-serif' }}>Phone</span>
                            <span className="text-blue-800 text-xs" style={{ fontFamily: 'poppins, sans-serif' }}>+91 79827 37801</span>
                          </div>
                        </a>
                        <a href="mailto:info@gridaneobharat.com" className="flex items-center gap-3 px-4 py-3 bg-white/20 backdrop-blur-sm rounded-full border border-white/30 justify-center">
                          ...
                          <div>
                            <span className="text-blue-900 font-semibold text-sm block" style={{ fontFamily: 'poppins, sans-serif' }}>Email</span>
                            <span className="text-blue-800 text-xs truncate" style={{ fontFamily: 'poppins, sans-serif' }}>info@gridaneobharat.com</span>
                          </div>
                        </a>
                        <a href="https://www.gridaneobharat.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 bg-white/20 backdrop-blur-sm rounded-full border border-white/30 justify-center">
                          ...
                          <div>
                            <span className="text-blue-900 font-semibold text-sm block" style={{ fontFamily: 'poppins, sans-serif' }}>Website</span>
                            <span className="text-blue-800 text-xs truncate" style={{ fontFamily: 'poppins, sans-serif' }}>www.gridaneobharat.com</span>
                          </div>
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="h-full text-center border-0 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 group/card" style={{ background: 'linear-gradient(135deg, #d1fae5 0%, #a7f3d0 50%, #6ee7b7 100%)', border: '2px solid rgba(16, 185, 129, 0.2)' }}>
                    <div className="relative p-8">
                      ...
                      <a href="https://maps.google.com/?q=Safdarjung+Enclave,+New+Delhi" target="_blank" rel="noopener noreferrer">
                        <button className="bg-gradient-to-r from-emerald-500 to-green-500 text-white border-none rounded-full px-8 py-4 h-auto font-semibold hover:shadow-lg transition-all duration-300" style={{ fontFamily: 'popiins, sans-serif' }}>
