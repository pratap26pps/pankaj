...
function ScrollToTopButton() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed bottom-4 cursor-pointer right-2  z-50 p-3 rounded-full bg-blue-600 text-white shadow-lg transition-opacity duration-300 hover:bg-blue-700 focus:outline-none ${visible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
